...
<form action="realizar.php" method="POST">
    ...
    <tr>
	  ...
	  <tr>
	   ...
	   <tr>
	   <td>Hora de inicio do evento: <input class="resp" size="60" name="hora_inicio" placeholder="  HH:MM:SS"></td>
	  </tr>
      <tr>
      ...
      <tr>
	   <td>Responsável evento: <input class="resp" size="60" name="responsavel"></td>
	  </tr>
